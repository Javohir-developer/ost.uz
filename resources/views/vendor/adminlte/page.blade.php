                    ...
                    <div class="sidebar">
                        <nav class="mt-2">
                            <ul class="nav nav-pills nav-sidebar flex-column " data-widget="treeview" role="menu">
                                <li class="nav-item ">
                                    <a class="nav-link " href="http://laravel1/admin/pages">
...
{{--                            <li class="nav-header">ACCOUNT SETTINGS</li>--}}
                                <li class="nav-item ">
                                    <a class="nav-link " href="http://laravel1/admin/settings">
                                ...
                                <li class="nav-item has-treeview">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item ">
                                            <a class="nav-link " href="#">
                                                <i class="far fa-fw fa-circle "></i><p>Level 1</p>
                                            </a>
                                        </li>
                                        <li class="nav-item ">
                                            <a class="nav-link " href="#">
...
{{--                                <li class="nav-header">LABELS</li>--}}
                                <li class="nav-item ">
                                    <a class="nav-link " href="#">
                                        <i class="far fa-fw fa-circle text-red"></i><p>Important</p>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link " href="#">
                                        <i class="far fa-fw fa-circle text-yellow"></i><p>Warning</p>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link " href="#">
                                        <i class="far fa-fw fa-circle text-aqua"></i><p>Information</p>
                                    </a>
                                </li>
                            </ul>
                        </nav>
